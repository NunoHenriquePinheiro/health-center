...
public class testeinserir4 extends JFrame 
{
...
static final String DEFAULT_QUERY = "SELECT * FROM mydb.Consulta";

private testeresult4 tableModel;
private JTextArea queryArea;

//create ResultSetTableModel2 and GUI
public testeinserir4( int a, int b, int c, int d, String e, String f, String g, String h ) 
{   
super( "Consultas");
...
try 
{
 ...
 tableModel = new testeresult4( JDBC_DRIVER, DATABASE_URL, 
    USERNAME, PASSWORD, DEFAULT_QUERY, a, b, c, d, e, f, g, h );
