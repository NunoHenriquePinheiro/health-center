...
public class inserirenfermeiro extends JFrame {
	...
	public inserirenfermeiro() {

		setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
		setTitle("Inserir Novo Enfermeiro no Sistema");
		setResizable(false);
		...
		jEditorPane2.setText("     INSERIR NOVO ENFERMEIRO NO SISTEMA");
		...
		jTextField12.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				new testeinserir6(nBI, nome, datanascimento, ntelemovel, mail,
