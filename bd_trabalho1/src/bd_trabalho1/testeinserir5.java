...
public class testeinserir5 extends JFrame 
{
...
static final String DEFAULT_QUERY = "SELECT * FROM mydb.Medico";

private testeresult5 tableModel;
private JTextArea queryArea;

//create ResultSetTableModel2 and GUI
public testeinserir5( int a, String b, String c, int d, String e, String f, String g, String h, String i, String j, String l, String m  ) 
{   
super( "Médicos no Sistema");


try 
{
 // create TableModel for results of query SELECT * FROM authors
 tableModel = new testeresult5( JDBC_DRIVER, DATABASE_URL, 
