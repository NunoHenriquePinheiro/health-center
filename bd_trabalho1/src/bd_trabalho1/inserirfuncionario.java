...
public class inserirfuncionario extends JFrame {
	...
	public inserirfuncionario() {
		...
		setTitle("Inserir Novo Funcionário no Sistema");
		setResizable(false);
		...
		jEditorPane2.setText("    INSERIR NOVO FUNCIONÁRIO NO SISTEMA");
		...
		jTextField12.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				new testeinserir7(nBI, nome, datanascimento, ntelemovel, mail,
