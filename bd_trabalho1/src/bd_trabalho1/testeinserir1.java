...
public class testeinserir1 extends JFrame 
{
...
static final String DEFAULT_QUERY = "SELECT * FROM mydb.Registo_Clinico";

private testeresult1 tableModel;
private JTextArea queryArea;

//create ResultSetTableModel2 and GUI
public testeinserir1( String a, int b, int c, String d, String e, String f, String g ) 
{   
super( "Registo Clínico" );
 

try 
{
   // create TableModel for results of query SELECT * FROM authors
   tableModel = new testeresult1( JDBC_DRIVER, DATABASE_URL, 
