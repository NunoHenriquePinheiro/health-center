...
public class medicocredenciais extends JFrame {
	...
	public medicocredenciais() {
		
		setTitle("Credenciais do Médico");
		setResizable(false);
        ...
        jLabel1.setText("Utilizador: Médico");
        ...
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	...
            	BI_med = Integer.parseInt(jTextField1.getText());
            }
        });
        ...
        jPasswordField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	...
            	password_med = jPasswordField1.getText();
            }
        });
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	try {
					...
					// query database
					ResultSet resultSet = statement.executeQuery("SELECT * FROM mydb.Medico");
					...
					for (int i = 1; i <= numberOfColumns; i++ )
					{
						...
						if (ColumnName.equals("password"))
						{
							while (resultSet.next())
							{
								...
								if ( (indexBI == contadorPass) && (passMed.equals(password_med)) )
								{
									passAceite= true;
									break;
								}
