...
public class testeinserir7 extends JFrame 
{
...
static final String DEFAULT_QUERY = "SELECT * FROM mydb.Funcionario";

private testeresult7 tableModel;
private JTextArea queryArea;

//create ResultSetTableModel2 and GUI
public testeinserir7( int a, String b, String c, int d, String e, String f, String g, String h, String i, String j, String l, String m  ) 
{   
super( "Funcionários no Sistema");


try 
{
 // create TableModel for results of query SELECT * FROM authors
 tableModel = new testeresult7( JDBC_DRIVER, DATABASE_URL, 
    USERNAME, PASSWORD, DEFAULT_QUERY, a, b, c, d, e, f, g, h, i, j, l, m );
