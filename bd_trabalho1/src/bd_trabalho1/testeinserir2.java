...
public class testeinserir2 extends JFrame 
{
...
static final String DEFAULT_QUERY = "SELECT * FROM mydb.Registo_Enfermagem";

private testeresult2 tableModel;
private JTextArea queryArea;

//create ResultSetTableModel2 and GUI
public testeinserir2( String a, int b, int c, String d, String e, String f, String g ) 
{   
super( "Registo de Enfermagem");


try 
{
 // create TableModel for results of query SELECT * FROM authors
 tableModel = new testeresult2( JDBC_DRIVER, DATABASE_URL, 
    USERNAME, PASSWORD, DEFAULT_QUERY, a, b, c, d, e, f, g );
