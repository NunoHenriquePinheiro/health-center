...
public class testeinserir8 extends JFrame 
{
...
static final String DEFAULT_QUERY = "SELECT * FROM mydb.Utente";

private testeresult8 tableModel;
private JTextArea queryArea;

//create ResultSetTableModel2 and GUI
public testeinserir8( int a, int b, String c, int d, String e, int f, String g, String h, String i, String j, String l  ) 
{   
super( "Utentes no Sistema");


try 
{
 // create TableModel for results of query SELECT * FROM authors
 tableModel = new testeresult8( JDBC_DRIVER, DATABASE_URL, 
    USERNAME, PASSWORD, DEFAULT_QUERY, a, b, c, d, e, f, g, h, i, j, l);
