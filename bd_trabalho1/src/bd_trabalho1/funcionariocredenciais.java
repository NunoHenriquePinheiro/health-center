...
public class funcionariocredenciais extends JFrame {
	...
	public funcionariocredenciais() {
		
		setTitle("Credenciais do Funcionário");
		setResizable(false);
        ...
        jLabel1.setText("Utilizador: Funcionário");
        ...
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	...
            	BI_func = Integer.parseInt(jTextField1.getText());
            }
        });
        ...
        jPasswordField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	...
            	password_func = jPasswordField1.getText();
            }
        });
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	try {
					...
					// query database
					ResultSet resultSet = statement.executeQuery("SELECT * FROM mydb.Funcionario");
					...
					for (int i = 1; i <= numberOfColumns; i++ )
					{
						...
						if (ColumnName.equals("password"))
						{
							while (resultSet.next())
							{
								...
								if ( (indexBI == contadorPass) && (passMed.equals(password_func)) )
								{
									passAceite= true;
									break;
								}
